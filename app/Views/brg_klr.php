  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="<?= base_url('home/user')?>">user</a></li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <a href="<?= base_url('home/tambah_barangk') ?>">
            ...
            <tbody>
              ...
              foreach($manda as $erwin){
               ...
               <tr>
                ...
                <td><?= $erwin ->tgl_k?></td>
                <td>
                 <a href="<?= base_url('home/edit_barangk/' . $erwin ->id_bk) ?>">
                   <button class="bi bi-pencil-square"></button>
                 </a>
                 <a href="<?= base_url('home/hapus_barangk/' . $erwin ->id_bk) ?>">
