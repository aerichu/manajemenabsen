        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="<?= base_url('home/aksi_edit_barangm') ?>" method="POST"> 
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">tgl m</label>
                  <div class="col-sm-10">
                    <input type="date" class="form-control" name="tgl_m" value="<?= $satu->tgl_m ?>">
                  </div>
                </div>
                <div class="row mb-3">
               ...
               <input type="hidden" name="id" value="<?= $satu->id_brgm ?>">
